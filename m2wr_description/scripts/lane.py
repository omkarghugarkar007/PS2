...
def detect_line_segments(cropped_edges):
    ...
    rho = 25  # precision in pixel, i.e. 1 pixel
    angle = np.pi / 180  # degree in radian, i.e. 1 degree
    min_threshold = 160  # minimal of votes
...
if __name__ == '__main__':
    ...
    rospy.init_node('image_lane', anonymous=True)
